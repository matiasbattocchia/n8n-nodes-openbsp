...
export const properties: INodeProperties[] = [
    ...
    options: [
      {
        ...
        description:
          "Fetch a conversation thread (org, contact, recent messages) for an AI agent",
      },
      {
        name: "Get Status",
        value: "getStatus",
      ...
      },
      {
        ...
        description:
          "Send an approved template (opens a conversation / works after 24h)",
      },
      {
        name: "Send Text",
        value: "sendText",
        ...
        description:
          "Send a plain text message (within the 24h service window)",
      },
    ],
    default: "sendText",
  },
  ...
  // Send Template
  {
    ...
    required: true,
    description:
      "Choose an approved template. Depends on the selected Account.",
    displayOptions: {
  ...
  },
  {
    ...
    default: "[]",
    description:
      'The full template "components" array, as sent to the WhatsApp Cloud API',
    displayOptions: {
      show: {
        resource: ["message"],
  ...
  // Get Status
  {
    ...
    required: true,
    description:
      "The OpenBSP message ID (UUID) returned when the message was sent",
    displayOptions: {
  ...
  // Get Context
  {
    ...
    default: "",
    description:
      "Conversation UUID. Leave empty to resolve from the Account + To address above.",
    displayOptions: {
    ...
    options: [
      {
        ...
        description: "Find contacts by name or address",
      },
      {
        name: "Get",
        value: "get",
  ...
  },
  {
    ...
    type: "string",
    default: "",
    description: "Matched against contact name and address (case-insensitive)",
